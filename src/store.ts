...
const defaultFlashcards: Flashcard[] = [
  ...
  // Behavioral
  { id: "fc13", question: "Tell me about a time you had a conflict with a team member", answer: "STAR: At BDO, disagreed with senior on approach to data pipeline. Situation: deadline pressure. Action: scheduled 1:1, presented benchmarks showing my approach 3x faster. Result: adopted my approach, shipped on time. Lesson: data > opinion.", category: "behavioral", deck: "Behavioral", difficulty: "easy", level: 4 },
  { id: "fc14", question: "Describe a project where you had to learn a new technology quickly", answer: "STAR: Needed to integrate LLM endpoints for client POC. Situation: 2-week deadline, zero LLM exp. Action: studied OpenAI API, built prototype in 3 days using Python + LangChain. Result: POC approved, led to $50k contract extension.", category: "behavioral", deck: "Behavioral", difficulty: "easy", level: 4 },
  { id: "fc15", question: "Tell me about a time you failed", answer: "STAR: Overscoped a React refactor at Nuclei. Situation: tried to rewrite component library in 2 weeks. Action: after 1 week, 30% done, admitted scope too big. Cut to incremental refactors. Result: shipped 80% of value in 3 incremental releases. Lesson: incremental > big bang.", category: "behavioral", deck: "Behavioral", difficulty: "medium", level: 3 },
  ...
  { id: "fc17", question: "Tell me about your most challenging technical problem", answer: "STAR: Building MCP server for OPG. Situation: needed real-time data from legacy SCADA. Action: designed pub/sub bridge using MCP tools, async tool calls with error recovery. Result: agents now query live plant data, reduced ops response time 60%.", category: "behavioral", deck: "Behavioral", difficulty: "medium", level: 3 },
